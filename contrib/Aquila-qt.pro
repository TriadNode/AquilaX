...
HEADERS + = src / bignum.h
           ...
           src / leveldb / include / leveldb / ch \
...
RESOURCES + = src / qt / Aquila.qrc src / qt / Aquila_locale.qrc

TRANSLATIONS + = src / qt / locale / Aquila_bg.ts \
                src / qt / local / Aquila_de.ts \
                src / qt / local / Aquila_en.ts \
                src / qt / local / Aquila_es.ts \
                src / qt / locale / Aquila_fi.ts \
                src / qt / local / Aquila_en.ts \
                src / qt / local / Aquila_it.ts \
                src / qt / local / Aquila_ja.ts \
                src / qt / local / Aquila_pl.ts \
                src / qt / local / Aquila_pt.ts \
                src / qt / local / Aquila_ru.ts \
                src / qt / local / Aquila_sk.ts \
                src / qt / locale / Aquila_sv.ts \
                src / qt / locale / Aquila_vi.ts \
                src / qt / locale / Aquila_zh_CN.ts \
                src / qt / local / Aquila_zh_TW.ts
